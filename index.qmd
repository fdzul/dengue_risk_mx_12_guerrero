...
::: {.box .b}
```{r forest_plot_acapulco, dpi = 300, fig.height= 5,fig.width = 7,fig.align = "center", out.height='100%', out.width = '100%',fig.show = "hold"}
 # Logistic Regression
hotspots <- hotspots |>
...
::: {.box .c}
```{r power_law_plot_acapulco,dpi = 300, warning=FALSE, fig.align = "center", out.width = '100%',out.height='100%',fig.show = "hold"}
...
::: {.box .d}
```{r gauge_blocks_acapulco,fig.align = "center", out.height='100%', out.width = '100%', fig.width= 1.5, fig.height=1}
...
::: {.box .e}
```{r gauge_AGEB_acapulco, fig.align = "center", out.height='100%', out.width = '100%'}
...
::: {.box .f}
```{r gauge_casos_acapulco, out.height='90%', out.width = '90%', fig.align = "center"}
...
::: {.box .b}
```{r forest_plot_chilpo, dpi = 300, fig.height= 5,fig.width = 7,fig.align = "center", out.height='100%', out.width = '100%',fig.show = "hold"}
...
::: {.box .c}
```{r power_law_plot_chilpo,dpi = 300, warning=FALSE, fig.align = "center", out.width = '100%',out.height='100%',fig.show = "hold"}
# Step 7. make the function por calculate the cumulative ####
funcumsum <- function(x){
    x$cumulative_n <- cumsum(x$n_cases)
    x$perc_cumsum_n <- round((cumsum(x$n_cases)/sum(x$n_cases))*100, digits = 1)
...
::: {.box .d}
```{r gauge_blocks_chilpo,fig.align = "center", out.height='100%', out.width = '100%', fig.width= 1.5, fig.height=1}
y_hot <- hotspots |> dplyr::filter(hotspots_gi == 1)
centroid <- rgeomex::blocks_ine20_mx_centroid |>
  sf::st_as_sf(coords = c("x", "y"), crs = 4326)
b_loc <- centroid[hotspots, ]
...
::: {.box .e}
```{r gauge_AGEB_chilpo, fig.align = "center", out.height='100%', out.width = '100%'}
...
::: {.box .f}
```{r gauge_casos_chilpo, out.height='90%', out.width = '90%', fig.align = "center"}
...
### [**Zihuatanejo**]{style="color:#990000"}
...
::: wrapper
::: {.box .a}
```{r hotspots_dengue_zihua}
# Step 1. extract the locality ####
loc <- rgeomex::extract_locality(cve_edo = "12", 
                                 locality = "Zihuatanejo")
...
::: {.box .b}
```{r forest_plot_zihua, dpi = 300, fig.height= 5,fig.width = 7,fig.align = "center", out.height='100%', out.width = '100%',fig.show = "hold"}
# Logistic Regression
hotspots <- hotspots |>
    dplyr::mutate(DENV_2008_2010 = DENV_2008 + DENV_2009 + DENV_2010) |>
    dplyr::mutate(DENV_2011_2014 = DENV_2011 + DENV_2012 + DENV_2013 + DENV_2014) |>
...
::: {.box .c}
```{r power_law_plot_zihua,dpi = 300, warning=FALSE, fig.align = "center", out.width = '100%',out.height='100%',fig.show = "hold"}
# Step 7. make the function por calculate the cumulative ####
funcumsum <- function(x){
    x$cumulative_n <- cumsum(x$n_cases)
    x$perc_cumsum_n <- round((cumsum(x$n_cases)/sum(x$n_cases))*100, digits = 1)
...
::: {.box .d}
```{r gauge_blocks_zihua,fig.align = "center", out.height='100%', out.width = '100%', fig.width= 1.5, fig.height=1}
y_hot <- hotspots |> dplyr::filter(hotspots_gi == 1)
centroid <- rgeomex::blocks_ine20_mx_centroid |>
  sf::st_as_sf(coords = c("x", "y"), crs = 4326)
b_loc <- centroid[hotspots, ]
...
::: {.box .e}
```{r gauge_AGEB_zihua, fig.align = "center", out.height='100%', out.width = '100%'}
...
::: {.box .f}
```{r gauge_casos_zihua, out.height='90%', out.width = '90%', fig.align = "center"}
...
::: wrapper
::: {.box .a}
```{r hotspots_dengue_iguala}
# Step 1. extract the locality ####
loc <- rgeomex::extract_locality(cve_edo = "12", 
                                 locality = "Iguala de la Independencia")
...
::: {.box .b}
```{r forest_plot_iguala, dpi = 300, fig.height= 5,fig.width = 7,fig.align = "center", out.height='100%', out.width = '100%',fig.show = "hold"}
# Logistic Regression
hotspots <- hotspots |>
    dplyr::mutate(DENV_2008_2010 = DENV_2008 + DENV_2009 + DENV_2010) |>
    dplyr::mutate(DENV_2011_2014 = DENV_2011 + DENV_2012 + DENV_2013 + DENV_2014) |>
...
::: {.box .c}
```{r power_law_plot_iguala,dpi = 300, warning=FALSE, fig.align = "center", out.width = '100%',out.height='100%',fig.show = "hold"}
# Step 7. make the function por calculate the cumulative ####
funcumsum <- function(x){
    x$cumulative_n <- cumsum(x$n_cases)
    x$perc_cumsum_n <- round((cumsum(x$n_cases)/sum(x$n_cases))*100, digits = 1)
...
::: {.box .d}
```{r gauge_blocks_iguala,fig.align = "center", out.height='100%', out.width = '100%', fig.width= 1.5, fig.height=1}
y_hot <- hotspots |> dplyr::filter(hotspots_gi == 1)
centroid <- rgeomex::blocks_ine20_mx_centroid |>
  sf::st_as_sf(coords = c("x", "y"), crs = 4326)
b_loc <- centroid[hotspots, ]
...
::: {.box .e}
```{r gauge_AGEB_iguala, fig.align = "center", out.height='100%', out.width = '100%'}
...
::: {.box .f}
```{r gauge_casos_iguala, out.height='90%', out.width = '90%', fig.align = "center"}
...
### [**Acapulco**]{style="color:#990000"}
```{r vector_hotspots_acapulco, dpi = 300, warning=FALSE, message=FALSE}
...
### [**Chilpancingo**]{style="color:#990000"}
```{r vector_hotspots_chilpo, dpi = 300, warning=FALSE, message=FALSE}
deneggs::map_eggs_hotspots(betas = denmex::eggs_betas_12_guerrero,
                           locality = "Chilpancingo de los Bravo",
                           cve_edo = "12",
                           static_map = TRUE,
...
### [**Zihuatanejo**]{style="color:#990000"}
```{r vector_hotspots_zihua, dpi = 300, warning=FALSE, message=FALSE}
deneggs::map_eggs_hotspots(betas = denmex::eggs_betas_12_guerrero,
                           locality = "Zihuatanejo",
                           cve_edo = "12",
                           static_map = TRUE,
...
```{r vector_hotspots_iguala, dpi = 300, warning=FALSE, message=FALSE}
deneggs::map_eggs_hotspots(betas = denmex::eggs_betas_12_guerrero,
                           locality = "Iguala de la Independencia",
                           cve_edo = "12",
                           static_map = TRUE,
